...
def main():
    ...
    datafiles = [
        ...
        root_dir / 'dummy' / 'battle_data' / 'dummy_vs_dual_1_results.csv',
        root_dir / 'dummy' / 'battle_data' / 'dummy_vs_dual_2_results.csv',

        root_dir / 'qlearning' / 'battle_data' / 'qlearning_vs_dummy_results.csv',
        root_dir / 'qlearning' / 'battle_data/' / 'qlearning_vs_wolf_results.csv',
        root_dir / 'qlearning' / 'battle_data/' / 'qlearning_vs_dqn_results.csv',
        root_dir / 'qlearning' / 'battle_data/' / 'qlearning_vs_dual_1_results.csv',
        root_dir / 'qlearning' / 'battle_data/' / 'qlearning_vs_dual_2_results.csv',

        root_dir / 'wolf' / 'battle_data' / 'wolf_vs_dummy_results.csv',
        root_dir / 'wolf' / 'battle_data' / 'wolf_vs_ql_results.csv',
        root_dir / 'wolf' / 'battle_data' / 'wolf_vs_dqn_results.csv',
        ...
        root_dir / 'dqn' / 'battle_data' / 'dqn_vs_ql_results.csv',
        root_dir / 'dqn' / 'battle_data' / 'dqn_vs_wolf_results.csv',
        root_dir / 'dqn' / 'battle_data' / 'dqn_vs_dual_1_results.csv',
        root_dir / 'dqn' / 'battle_data' / 'dqn_vs_dual_2_results.csv',

        root_dir / 'dual' / 'agent_1' / 'battle_data' / 'dual_1_vs_dummy_results.csv',
        root_dir / 'dual' / 'agent_1' / 'battle_data' / 'dual_1_vs_ql_results.csv',
        root_dir / 'dual' / 'agent_1' / 'battle_data' / 'dual_1_vs_wolf_results.csv',
        root_dir / 'dual' / 'agent_1' / 'battle_data' / 'dual_1_vs_dqn_results.csv',
        root_dir / 'dual' / 'agent_1' / 'battle_data' / 'dual_1_vs_dual_2.csv',

        root_dir / 'dual' / 'agent_2' / 'battle_data' / 'dual_2_vs_dummy_results.csv',
        root_dir / 'dual' / 'agent_2' / 'battle_data' / 'dual_2_vs_ql_results.csv',
        root_dir / 'dual' / 'agent_2' / 'battle_data' / 'dual_2_vs_wolf_results.csv',
        root_dir / 'dual' / 'agent_2' / 'battle_data' / 'dual_2_vs_dqn_results.csv',
